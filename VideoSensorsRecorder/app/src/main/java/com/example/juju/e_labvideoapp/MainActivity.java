...
*/
    ...
    class SayHello extends TimerTask {
        public void run() {
            ...
            writer.println(timeStamp + "," + longitude_original + "," + latitude_original + "," +
                    rotv_x + "," + rotv_y + "," + rotv_z + "," + rotv_w + "," + rotv_accuracy + "," +
                    speed + "," + dist[0] + "," + linear_acc_x + "," + linear_acc_y + "," + linear_acc_z + "," + heading + "," +
    ...
    public void storeData() {
        ...
        writer.println("Timestamp" + "," + "Longitude" + "," + "Latitude" + "," +
                "RotationV X" + "," + "RotationV Y" + "," + "RotationV Z" + "," + "RotationV W" + "," + "RotationV Acc" + "," +
                "Speed" + "," + "Distance" + "," + "Acc X" + "," + "Acc Y" + "," + "Acc Z" + "," + "Heading" + "," +
                "gyro_x" + "," + "gyro_y" + "," + "gyro_z");
